...
int main () {
   ...
   int threshold = 100;  // threshold for binarizing the document image
   readJpeg( inputImage, "images/train1.jpg" );
   ...
   cc.analyzeBinary( binary, EIGHT_CONNECTED );  // connected component labelling
   ...
   for (c = 0; c < cc.getNumComponents(); c++) {
     ...
     sprintf( charFileName, "images/charseg/%04d.jpg", c ); 
