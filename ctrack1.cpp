...
int main(int argc, char *argv[]) {
  ...
  system("mkdir images/output/exer_12/colortrack");
  strcpy(outputFileFormat, "images/output/exer_12/colortrack/%04d.jpg");
  ...
  writeJpeg(currentFrame, "images/output/exer_12/ctrack/traject.jpg", 90);
}
