...
int main () {
   ...
   double minimumHue = -pi/4;   // range is 0.0 to 2 * pi
   double maximumHue = pi / 4;   // range is 0.0 to 2 * pi
   double minimumSaturation = 0.3;   // range is 0.0 to 1.0
   double maximumSaturation = 1.0;   // range is 0.0 to 1.0
   ...
   readJpeg( inputImage, "images/scene1.jpg" );
